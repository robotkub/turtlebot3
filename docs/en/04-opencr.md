...
- `flash_opencr.sh` — **one command** to flash it all from the Pi
- `turtlebot3_burger_custom/turtlebot3_burger_custom.ino` — the sketch
...
It installs `arduino-cli` + the OpenCR board core, **disables the SW1/SW2
...
straight to the **Pi's GPIO** (covered in [Chapter 7](07-run-mission.md) and
